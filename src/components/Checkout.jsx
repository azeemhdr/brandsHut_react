              ...
              <div className={` ${styles.address_modal_wrapper } `}>
                ...
                <hr className="mt-0"/>
                  <form action="" className="px-3">
								...
								<div className="mb-3">
									<input type="tel" name="phone" maxLength={10} id="" placeholder="Phone Number" className="form-control"/>
								</div>
								<div className="mb-3">
									<input type="text" name="address" id="" placeholder="Address Line 1" className="form-control"/>
								</div>
								<div className="mb-3">
									<input type="text" name="address" id="" placeholder="Address Line 2" className="form-control"/>
								</div>
								<div className="mb-3">
									<input type="text" name="address" id="" placeholder="Address Line 3" className="form-control"/>
								</div>
								<div className='mb-3'>
                                    <div className='row'>
                                        <div className='col-6'>
